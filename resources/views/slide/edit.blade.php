...
<div class="uk-text-justify uk-margin-remove-top" uk-grid>
    ...
    <div class="uk-width-1-3@m">
        ...
        <div class="uk-card uk-card-default uk-card-body card-k uk-border-rounded uk-text-break uk-transition-toggle uk-padding-remove uk-grid-collapse uk-grid uk-margin-top uk-box-shadow-hover-medium"
            style="border: 1px solid rgb(223, 223, 223);;">

            <div style="border-radius: 4px 0px 0px 4px !important"
                class=" uk-card-media-right uk-cover-container uk-width-1-5 uk-width-1-4@s uk-first-column uk-margin-right ">
                <div uk-cover="" class="uk-cover" style="width: 130px; height: 130px;">
                    <img uk-img="" data-type="image" uk-cover="" src="../../storage/banner_images/{{$banner->imagem}}"
                        class="uk-cover" style="width: 133px; height: 130px;">
