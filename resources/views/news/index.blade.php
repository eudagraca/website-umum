...
<section class="uk-padding-remove-top uk-section uk-section-small">
    <div class="uk-container uk-container-small">
        <h2 class="uk-heading-bullet uk-text-bold uk-h2 uk-margin-remove-adjacent uk-margin-remove-top">Notícias
        </h2>
    ...
    <div class="uk-container">
        <div class="uk-padding-large-bottom" style="margin:0 5%; padding:1%">
            ...
            <div class="noticias-recentes" id="noticias-recentes">
                ...
                <div id="container-noticias" class="uk-grid-column-small uk-grid-row-large uk-child-width-1-2@s"
                    uk-grid>
                    <?php $n = 0  ?>
                    @while ($n<3) <div>
                        <div class="uk-card uk-card-default uk-card-body card-k uk-border-rounded uk-text-break uk-transition-toggle uk-padding-remove uk-grid-collapse uk-grid itens-shared"
                            ...
                            <div style="border-radius: 4px 0px 0px 4px !important"
                                class="uk-card-media-right uk-cover-container uk-width-1-4 uk-width-1-4@s uk-first-column uk-margin-right">
                                <div uk-cover="" class="uk-cover" style="width: 130px; height: 130px;">
                                    <img uk-img="" data-type="image" uk-cover="" src="storage/images/light.jpg"
                                        class="uk-cover" style="width: 133px; height: 100%;">
                            ...
                            <div class="uk-width-expand">
                                <p
                                    ...
                                    Title</p>
                                <p class="uk-margin-remove uk-text-truncate uk-text-large uk-text-light">Info start
                                </p>
